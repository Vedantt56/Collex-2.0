...
export default function AdminLogin() {
  ...
  return (
    <section className="relative flex min-h-screen items-center justify-center overflow-hidden px-4 py-12">
      ...
      >
        <p className="text-indigo-600 dark:text-indigo-300 text-xs mt-10 font-bold uppercase tracking-[0.35em]">
          COLLEX
        </p>
        <h1 className="text-slate-950 dark:text-white text-3xl mt-2 font-medium">Admin Login</h1>
        ...
        >
          Not an admin?
          <span className="text-indigo-400 hover:underline ml-1">go back</span>
        </p>
      </form>
    </section>
  );
